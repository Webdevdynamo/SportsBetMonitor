...
<head>
    ...
    <style>
        ...
        .status-ribbon { position: absolute; top: 10px; right: -10px; transform: rotate(45deg); width: 70px; text-align: center; font-size: 0.65em; font-weight: bold; color: #fff; z-index: 11; text-transform: uppercase; letter-spacing: 1px; pointer-events: none; }
...
<script>
    ...
    function renderDashboard(liveData) {
        ...
        mySlips.forEach(slip => {
            ...
            let metaHtml = (slip.odds || slip.wager) ? `<div class="slip-meta" style="display: flex; justify-content: space-between; margin-bottom: 15px; font-size: 0.8em; color: #888; border-bottom: 1px solid #222; padding-bottom: 10px;">
            ...
            card.innerHTML = ribbonHtml + `<div class="slip-header"><span>SLIP: ${slip.slip_id}</span></div>` + metaHtml + legsHtml;
